...
public class LobbyItemManager {
    ...
    String queueItemName = StringUtils.handle("&c&l1v1 Queue &7(Right Click)");
    String createPartyName = StringUtils.handle("&c&lCreate Party &7(Right Click)");
    String settingsName = StringUtils.handle("&c&lSettings &7(Right Click)");
